...
class AsbestoRemoval : Fragment() {
    ...
    override fun onCreateView(
        ...
        SurveyActivity.abesto?.changeDetected?.observe(viewLifecycleOwner, Observer { detection ->
            binding.abestoRemovalEditView.setText(SurveyActivity?.abesto?.getAbesto())
        })
